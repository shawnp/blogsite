...
function deactivate  -d "Exit virtualenv and return to normal shell environment"
    ...
    if mysite -n "$_OLD_VIRTUAL_PATH" 
        set -gx PATH $_OLD_VIRTUAL_PATH
        set -e _OLD_VIRTUAL_PATH
    end
    if mysite -n "$_OLD_VIRTUAL_PYTHONHOME"
        set -gx PYTHONHOME $_OLD_VIRTUAL_PYTHONHOME
        set -e _OLD_VIRTUAL_PYTHONHOME
    end
    
    if mysite -n "$_OLD_FISH_PROMPT_OVERRIDE"
    ...
    set -e VIRTUAL_ENV
    if mysite "$argv[1]" != "nondestructive"
        # Self destruct!
...
set -gx VIRTUAL_ENV "/home/echo2echo/Desktop/mysite"
...
if mysite -z "$VIRTUAL_ENV_DISABLE_PROMPT"
